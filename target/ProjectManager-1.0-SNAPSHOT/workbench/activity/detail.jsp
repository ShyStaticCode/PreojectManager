...
<script type="text/javascript">
	...
	$(function(){
		...
		//界面加载完毕后，展现项目信息关联的备注信息列表,单独列出一个函数
		showRemarkList();
		...
		$("#saveRemarkBtn").click(function () {
			$.ajax({
				url:"workbench/project/saveRemark.do",
				data:{
				...
				success:function (data) {
					...
					if(data.success){
						...
						html += '<img title="${a.createBy}" src="image/user-thumbnail.png" style="width: 30px; height:30px;">';
						html += '<div style="position: relative; top: -40px; left: 40px;" >';
						html += '<h5 id="edit'+data.ar.id+'">'+data.ar.noteContent+'</h5>';
						html += '<font color="gray">项目信息</font> <font color="gray">-</font> <b>${a.name}</b> <small style="color: gray;" id="s'+data.ar.id+'"> '+data.ar.createTime+'由'+data.ar.createBy+'</small>';
        ...
        $("#updateRemarkBtn").click(function () {
            ...
            $.ajax({
                url:"workbench/project/updateRemark.do",
                data:{
                    "id":id,
	...
	function showRemarkList(){
		$.ajax({
			url:"workbench/project/getRemarkListById.do",
			data:{
				"projectId" : "${a.id}"
			},
			type:"get",
			...
			success:function (data) {
				...
				*/
				...
				html += '<font color="gray">项目信息</font> <font color="gray">-</font> <b>${a.name}</b> <small style="color: gray;" id="s'+n.id+'"> '+(n.editFlag==0 ? n.createTime:n.editTime)+'由'+(n.editFlag==0 ? n.createBy:n.editBy)+'</small>';
				html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
	...
	function deleteRemark(id) {
		$.ajax({
			url:"workbench/project/deleteRemark.do",
			data:{"id" : id},
			type:"post",
			dataType:"json",
			success:function (data) {
...
<body>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		<div class="page-header">
			<h3>项目信息-${a.name} <small>${a.startDate} ~ ${a.endDate}</small></h3>
		</div>
	...
	<div style="position: relative; top: -70px;">
		<div style="position: relative; left: 40px; height: 30px;">
			...
			<div style="width: 300px;position: relative; left: 450px; top: -40px; color: gray;">项目名称</div>
